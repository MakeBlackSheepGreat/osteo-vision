...
**Constitution Alignment**: Generated tasks MUST include project-specific work
for medical safety, configurable boundaries, data governance, evidence artifacts,
and regression checks whenever the feature touches those areas.
...
- [ ] T0XX [P] [US1] Evidence artifact test for [overlay/report/json/csv] in tests/unit/test_[name].py
- [ ] T0XX [P] [US1] Medical safety wording test for disclaimers and no unsupported diagnosis claims
...
- [ ] T0XX [US1] Save reproducible output artifacts to the planned artifacts/reports location
