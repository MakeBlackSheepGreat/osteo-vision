...
**Out of Scope**: [Device SDKs, hospital integrations, automatic clinical diagnosis, or other excluded work]
...
- **[Artifact 1]**: [e.g., overlay PNG, heatmap PNG, report JSON, quantification CSV, Markdown report]
- **[Artifact 2]**: [Where it is stored and how it can be reproduced]
...
- **SC-005**: [Evidence metric, e.g., "A sample case produces all expected artifacts with no unsupported clinical claims"]
