...
- **Configurable architecture**: New behavior enters through YAML config,
  manifests, adapters, pipelines, preprocessing modules, or report writers
  without hard-coding model families, datasets, thresholds, or clinical claims
  into shared infrastructure.
- **Data governance**: Sensitive data handling, de-identification, provenance,
  artifact retention, and Git exclusion rules are documented.
- **Evidence and tests**: Plan names the tests, smoke checks, reports, metrics,
  screenshots, JSON/CSV outputs, or failure evidence required for acceptance.
