...
def main(argv: Iterable[str] | None = None) -> None:
    ...
    parser.add_argument("--anatomy-mask", default=None, help="Optional .npy/.npz anatomy mask, e.g. DentalSegmentator output.")
    parser.add_argument("--foreground-labels", default=None, help="Comma-separated anatomy labels to use as foreground.")
    parser.add_argument("--margin", type=_margin_arg, default=8, help="One value or z,y,x margin voxels. Default: 8.")
    parser.add_argument("--fallback-crop-shape", default=None, help="Optional z,y,x center crop shape when no foreground exists.")
