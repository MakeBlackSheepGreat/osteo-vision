...
from backend.osteo_vision_api.domains.annotations.repository import AnnotationNotFoundError, AnnotationRepository
...
class ManualAnnotationService:
    ...
    def save_version(
        ...
        if record.current_version != request.expected_version:
            from backend.osteo_vision_api.domains.annotations.repository import AnnotationVersionConflictError
