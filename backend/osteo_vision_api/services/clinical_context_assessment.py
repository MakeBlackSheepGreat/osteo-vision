...
from backend.osteo_vision_api.domains.cases.schemas import ClinicalContext, ClinicalLabResult
from osteo_vision_core.core.clinical_context_verification import clinical_context_verification_issues
