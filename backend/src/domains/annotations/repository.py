...
from backend.src.domains.annotations.enums import AnnotationStatus
from backend.src.domains.annotations.schemas import AnnotationVersionRecord, ManualAnnotationRecord
