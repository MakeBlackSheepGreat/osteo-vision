...
from backend.src.reports.platform_report_sections import three_d_evidence_section_from_run, video_signal_section_from_run
...
def build_platform_report(case: CaseRecord, *, export_meta: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "three_d_evidence": three_d_evidence_section_from_run(latest_run),
