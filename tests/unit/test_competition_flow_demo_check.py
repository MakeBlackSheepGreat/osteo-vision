...
from tools.run_competition_flow_demo_check import (
...
def test_competition_flow_defaults_to_strict_runtime(monkeypatch) -> None:
    monkeypatch.setattr(sys, "argv", ["run_competition_flow_demo_check.py"])
