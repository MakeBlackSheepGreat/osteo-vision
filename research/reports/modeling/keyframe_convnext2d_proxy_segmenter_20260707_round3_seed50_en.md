...
- Manifest count: 1; sample-weight stats: `{"count": 150, "min": 1.0, "median": 1.0, "max": 1.0, "mean": 1.0}`
- Review-state counts: `{"review_required": 150}`
- Train samples: 112; validation samples: 38.
- Pseudo-label quality gates: `{}`
- Human-review seed set: 0; path: `None`
- Training batches: 8; batch size: 4.
- Mean train loss: 0.6774
- Device: cuda; PyTorch: 2.11.0+cu128.

## Metrics

- Foreground Dice: 0.0000
- Foreground IoU: 0.0000
- Prediction positive fraction: 0.0000
