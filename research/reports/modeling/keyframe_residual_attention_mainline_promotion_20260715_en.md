...
`keyframe_residual_attention_unet_s20260715_20260715` is now the platform mainline for JPEG/MP4 keyframe segmentation. The strict runtime, development runtime, and task package select the promoted checkpoint. `convnext2d_keyframe_proxy_segmenter` remains available as the previous engineering comparator.
...
- Strict production runtime sets `allow_heuristic_keyframe_fallback=false`; an unavailable model produces a structured failed analysis.
...
| Post-promotion 4K platform flow | Passed | `b51dc0d7df0d668bc6da2fe8eebf1d1a88fb10775a0a7780285ae0c4a2efe46b` |
