...
- DentalSegmentator provides a public nnU-Net v2.2 pretrained model and Slicer extension for dento-maxillo-facial CT/CBCT anatomical structures. It is not a lesion model. The project now has a local CBCT ROI preprocessing contract that can consume DentalSegmentator-style anatomy masks.
...
3. Use the new CBCT ROI preprocessing contract now, then integrate DentalSegmentator checkpoint inference as the anatomy-prior provider later.
