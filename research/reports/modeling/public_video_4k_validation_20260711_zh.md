...
本轮依据项目输入规范和设备技术文档，验证平台对输入边界的工程适配能力。设备文档明确规定 4K 摄录分辨率为 `3840x2160`，图片格式为 JPEG，视频格式为 MP4。本轮覆盖公开真实视频抽帧复核、长 MP4、不同帧率、不可读 MP4、公开来源帧派生 4K JPEG、强制 tiling、模型失败回退和短时持续内存观察。
