...
当前项目已经具备“官方 MP4/JPEG 输入雏形 + 前后端病例工作台 + 公开 CBCT 代理数据 + 荧光/骨髓炎公开视频资料”的基础，但核心风险没有消失：真实目标域 4K 白光/ICG 术中 MP4/JPEG、医生标注和可用于训练的颌骨骨髓炎荧光数据仍然缺失。近期开发应先把官方输入闭环、关键帧、ROI 标注和证据包做实，再用公开 CBCT 与荧光代理数据支撑模型平台验证。
...
真实的 4K 白光/ICG 术中 MP4/JPEG 样本仍然是最大缺口。公开检索没有找到“颌骨骨髓炎 + ICG 荧光 + 可下载 MP4 + 像素级标注”的数据集；医院 CBCT 预计也只有 4-5 例，无法支撑独立临床级训练。赛点二必须定位为平台验证和医生复核辅助，不能承诺自动诊断。
