...
赛题官方技术资料把 1000-1700 nm NIR-II 列为可参考研究方向。现有设备已经确认的光学窗口仍为 ICG 约 750-810 nm 激发和约 830 nm 发射。企业确认 NIR-II 光源、InGaAs 探测器、滤光片和同步采集链路前，训练结果只能作为算法储备。
...
4. 目标域小金标准集按病例切分，保持独立测试集；在目标域测试通过前不替换比赛主线 checkpoint。
