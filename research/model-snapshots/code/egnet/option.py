...
def parse_args():
    ...
    # models
    parser.add_argument("--pretrain", type=str, action='store', default="/home/dengbinquan/XIAOWU/EGDBNet/ckpt/ISIC17_best/best.pt")
    parser.add_argument("--model", type=str, default="network_PS")
    parser.add_argument("--GPU_ID", type=int, default=0)
    parser.add_argument("--pvt_path", type=str, default="/home/dengbinquan/XIAOWU/PA-Net/model/pretrain/pvt_v2_b2.pth")

    # dataset
    parser.add_argument("--dataset_root", action='store', type=str, default='/home/dengbinquan/XIAOWU/PA-Net/data/ISIC2017/')
    parser.add_argument("--dataset", type=str, default="ISIC17_B")
    parser.add_argument("--test_dataset", type=str, default="ISIC2017_B") 
    ...
    parser.add_argument("--ckpt_root", type=str, default="./ckpt3/")
    parser.add_argument("--save_root", type=str, default="./output1")
    parser.add_argument("--save_msg", type=str, default="")
    parser.add_argument("--save", type=str, default="ckpt3/")
