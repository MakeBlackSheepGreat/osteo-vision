...
DOLCHID is the closest current dataset for platform point 2 because it contains CBCT lesion masks and paired histology images. It is still not intraoperative ICG fluorescence data. Diagnosis-group meanings must be verified from source documentation before any clinical wording is used.
"""
