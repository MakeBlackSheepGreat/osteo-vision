...
#### 任务包加载 (`osteo_vision_core/core/task_package.py`)

```python
from osteo_vision_core.core.task_package import load_task_package, default_task_package
...
#### 数据清单读取 (`osteo_vision_core/datasets/manifests.py`)
...
#### 数据分割 (`osteo_vision_core/datasets/splits.py`)
...
- `osteo_vision_core/core/task_package.py`：任务包加载和管理
- `osteo_vision_core/datasets/manifests.py`：数据清单读取
- `osteo_vision_core/datasets/splits.py`：数据分割
- `osteo_vision_core/engine/benchmark.py`：基准测试
- `osteo_vision_core/engine/inference.py`：推理服务
