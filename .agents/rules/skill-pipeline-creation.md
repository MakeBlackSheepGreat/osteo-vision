...
- 涉及分类、检测、分割等任务
- 需要组合多个处理步骤
- 修改 `osteo_vision_core/pipelines/` 目录下的文件
- 涉及流水线注册、流水线配置、流水线执行
...
```python
from osteo_vision_core.pipelines.classification import ClassificationPipeline
...
```python
from osteo_vision_core.pipelines.detection import DetectionPipeline
...
```python
from osteo_vision_core.pipelines.multitask import MultitaskPipeline
...
```python
from osteo_vision_core.engine.inference import PIPELINE_CLASSES
from osteo_vision_core.pipelines.my_pipeline import MyPipeline
...
- `osteo_vision_core/pipelines/__init__.py`：流水线模块入口
- `osteo_vision_core/pipelines/base.py`：流水线基类（Pipeline、PipelineContext）
- `osteo_vision_core/pipelines/classification.py`：分类流水线
- `osteo_vision_core/pipelines/segmentation.py`：分割流水线
- `osteo_vision_core/pipelines/detection.py`：检测流水线
- `osteo_vision_core/pipelines/quantification.py`：量化流水线
- `osteo_vision_core/pipelines/multitask.py`：多任务流水线
