...
- 集成新的深度学习模型
- 涉及模型推理、训练、评估
- 修改 `osteo_vision_core/models/` 目录下的文件
- 涉及模型注册、模型选择、模型加载
...
```python
from osteo_vision_core.models.adapters import BaseModelAdapter
...
```python
from osteo_vision_core.models.adapters import select_adapter, build_adapters
...
```python
from osteo_vision_core.models.adapters import ADAPTER_CLASSES
...
from osteo_vision_core.models.adapters import BaseModelAdapter, DEPENDENCY_MODULES
...
```python
from osteo_vision_core.models.adapters import ADAPTER_CLASSES
from osteo_vision_core.models.my_adapter import MyModelAdapter
...
- `osteo_vision_core/models/__init__.py`：模型模块入口
- `osteo_vision_core/models/adapters.py`：模型适配器核心
- `osteo_vision_core/models/classifier.py`：确定性分类器
- `osteo_vision_core/models/detector.py`：固定检测器
- `osteo_vision_core/models/segmenter.py`：固定分割器
- `osteo_vision_core/models/registry.py`：模型注册和加载
- `osteo_vision_core/core/schemas.py`：数据模式定义（ModelSpec、AdapterRequest、AdapterResult 等）
