...
def save_video_signal_maps(
    *,
    ...
    write_activity_score: bool = True,
    ...
    resolved_activity_score_path = None
    if write_activity_score:
    ...
    return {
        ...
        "activity_score_path": str(resolved_activity_score_path) if resolved_activity_score_path is not None else None,
        "risk_summary": {
